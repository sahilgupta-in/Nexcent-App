...
const Footer = () => {
  return (
        ...
        <div className='bg-[#263238] text-white pt-8 pb-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80 '>
                    <img src={logo} alt="logo" className='mb-4 h-8 md:h-9' />
                    <p className='text-sm'>
                       Copyright © 2020 Landify UI <br />
                       All rights reserved
                    </p>
                ...
                <div className='max-w-80'>
                    <p className='text-lg text-white'>STAY UP TO DATE</p>
